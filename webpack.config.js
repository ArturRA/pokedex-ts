...
module.exports = {
  ...
  entry: {
    index: path.resolve(__dirname, 'src/views', 'pokemon-listagem', 'pokemon-listagem.ts'),
  ...
  plugins: [
    new HtmlWebpackPlugin({
      filename: 'index.html',
      template: path.resolve(__dirname, 'src/views', 'pokemon-listagem', 'pokemon-listagem.html'),
      chunks: ['index']
    }),
